...
| Driver boarding QR | `widgets/boarding_qr_panel.dart` — wakelock + auto-refresh (**morning-only**) |
| Commuter scan | `screens/boarding_scan_screen.dart` — route `RouteName.boardingScan` (**morning-only**) |
